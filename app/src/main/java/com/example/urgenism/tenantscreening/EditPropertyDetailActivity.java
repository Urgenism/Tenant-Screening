...
public class EditPropertyDetailActivity extends AppCompatActivity
    ...
    private EditText _propertyNameET, _propertyNo, _addressET, _wardNoET,
            _municipalityET, _districtET, _zoneET, _note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (p_ID.equals(DEFAULT) || p_Name.equals(DEFAULT) || B_Type.equals(DEFAULT)
                ...
                || district.equals(DEFAULT) || zone.equals(DEFAULT) || note.equals(DEFAULT)
                || p_No.equals(DEFAULT)) {
    ...
    public void updateProperty(String p_ID) {
        ...
        PropertyInformation property = new PropertyInformation(p_ID, spinner, propertyName, propertyNumber,
                address, wardNo, municipality, district, zone, note);
    ...
    public boolean validate() {
        ...
        if (spinner.equals("Select Property type")) {
            ((TextView) buildingSpinner.getSelectedView()).setError("Select Property type");
            valid = false;
        } else {
        ...
        if (wardNo.isEmpty()) {
            _wardNoET.setError("Enter the ward number");
            valid = false;
        } else {
